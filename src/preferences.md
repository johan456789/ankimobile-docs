...
deletions propagate to other devices. After tapping the button and confirming, the Synchronize button on the deck list will turn red. The next time you sync you’ll
